...
class TestBase(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.driver.get(f'http://localhost:{self.TEST_PORT}/new-plan')
    ...
    def test_server_connectivity(self):
        response = urlopen(f'http://localhost:{self.TEST_PORT}/new-plan')
